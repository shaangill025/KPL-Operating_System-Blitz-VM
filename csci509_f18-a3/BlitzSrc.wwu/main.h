...
extern const char * inputFileNames [MAX_INPUT_FILES+1];    // Array of ptrs to file names
...
const char * extractFilename (Token token);
void incrLineNumber ();
int getNextChar ();
...
void printCharPtrField (int indent, const char * str, const char * charPtr);
...
char * newMethodName (const char * sanitizedClassName, int i);
