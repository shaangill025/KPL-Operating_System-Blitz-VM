...
void IRLoadAddr (AstNode * dest, const char * stringName);

class LoadAddr : public IR {
  public:
    AstNode * dest;         // Either local, global, or parameter
    const char * stringName;      // A string Constant

    LoadAddr (AstNode * d, const char * s) : IR (OPLoadAddr) {
      dest = d;
      stringName = s;
    }
    ~LoadAddr () {}
...
void IRLoadAddrIndirect (AstNode * dest, const char * stringName);
...
class LoadAddrIndirect : public IR {
  public:
    ...
    LoadAddrIndirect (AstNode * d, const char * s) : IR (OPLoadAddrIndirect) {
      dest = d;
      stringName = s;
    }
    ~LoadAddrIndirect () {}
...
void IRCheckVersion (const char * str, int i, const char * lab1);

class CheckVersion : public IR {
  public:
    const char * mySaniName;
    int myHashVal;
    const char * label1;

    CheckVersion (const char * str, int i, const char * lab1) : IR (OPCheckVersion) {
      myHashVal = i;
      mySaniName = str;
      label1 = lab1;
    }
...
void IRCallCheckVersion (const char * str, int i, const char * lab2);

class CallCheckVersion : public IR {
  public:
    const char * theirSaniName;
    int theirHashVal;
    const char * label2;

    CallCheckVersion (const char * str, int i, const char * lab2) : IR (OPCallCheckVersion) {
      theirHashVal = i;
      theirSaniName = str;
      label2 = lab2;
    }
...
void IREndCheckVersion (const char * lab2);

class EndCheckVersion : public IR {
  public:
    const char * label2;

    EndCheckVersion (const char * lab2) : IR (OPEndCheckVersion) {
      label2 = lab2;
    }
    ~EndCheckVersion () {}
    virtual void print ();
...
void IRStartCheckVersion (const char * str, int i, const char * lab);

class StartCheckVersion : public IR {
  public:
    const char * mySaniName;
    int myHashVal;
    const char * continueLab;

    StartCheckVersion (const char * str, int i, const char * lab) : IR (OPStartCheckVersion) {
      myHashVal = i;
      mySaniName = str;
      continueLab = lab;
    }
...
void IRVarDesc1 (const char * lab, VarDecl * vd, int sz);
...
class VarDesc1 : public IR {
  public:
    ...
    VarDesc1 (const char * lab, VarDecl * vd, int sz) : IR (OPVarDesc1) {
      label = lab;
      varDecl = vd;
      sizeInBytes = sz;
    }
...
void IRVarDesc2 (const char * lab, char k, const char * n);
...
class VarDesc2 : public IR {
  public:
    ...
    VarDesc2 (const char * lab, char k, const char * n) : IR (OPVarDesc2) {
      label = lab;
      kind = k;
      name = n;
    }
...
void IRIntLEGoto (AstNode * a1, AstNode * a2, const char * lab);
...
class IntLEGoto : public IR {
  public:
    ...
    IntLEGoto (AstNode * a1, AstNode * a2, const char * lab) : IR (OPIntLEGoto) {
      arg1 = a1;
      arg2 = a2;
      label = lab;
    }
...
void IRIntNEGoto (AstNode * a1, AstNode * a2, const char * lab);
...
class IntNEGoto : public IR {
  public:
    ...
    IntNEGoto (AstNode * a1, AstNode * a2, const char * lab) : IR (OPIntNEGoto) {
      arg1 = a1;
      arg2 = a2;
      label = lab;
    }
...
void IRFloatLTGoto (AstNode * a1, AstNode * a2, const char * lab);
...
class FloatLTGoto : public IR {
  public:
    ...
    FloatLTGoto (AstNode * a1, AstNode * a2, const char * lab) : IR (OPFloatLTGoto) {
      arg1 = a1;
      arg2 = a2;
      label = lab;
    }
...
void IRFloatLEGoto (AstNode * a1, AstNode * a2, const char * lab);
...
class FloatLEGoto : public IR {
  public:
    ...
    FloatLEGoto (AstNode * a1, AstNode * a2, const char * lab) : IR (OPFloatLEGoto) {
      arg1 = a1;
      arg2 = a2;
      label = lab;
    }
...
void IRFloatGTGoto (AstNode * a1, AstNode * a2, const char * lab);
...
class FloatGTGoto : public IR {
  public:
    ...
    FloatGTGoto (AstNode * a1, AstNode * a2, const char * lab) : IR (OPFloatGTGoto) {
      arg1 = a1;
      arg2 = a2;
      label = lab;
    }
...
void IRFloatGEGoto (AstNode * a1, AstNode * a2, const char * lab);
...
class FloatGEGoto : public IR {
  public:
    ...
    FloatGEGoto (AstNode * a1, AstNode * a2, const char * lab) : IR (OPFloatGEGoto) {
      arg1 = a1;
      arg2 = a2;
      label = lab;
    }
...
void IRFloatEQGoto (AstNode * a1, AstNode * a2, const char * lab);
...
class FloatEQGoto : public IR {
  public:
    ...
    FloatEQGoto (AstNode * a1, AstNode * a2, const char * lab) : IR (OPFloatEQGoto) {
      arg1 = a1;
      arg2 = a2;
      label = lab;
    }
...
void IRFloatNEGoto (AstNode * a1, AstNode * a2, const char * lab);
...
class FloatNEGoto : public IR {
  public:
    ...
    FloatNEGoto (AstNode * a1, AstNode * a2, const char * lab) : IR (OPFloatNEGoto) {
      arg1 = a1;
      arg2 = a2;
      label = lab;
    }
...
void IRBoolTest (AstNode * a, const char * lab1, const char * lab2);
...
class BoolTest : public IR {
  public:
    ...
    BoolTest (AstNode * a, const char * lab1, const char * lab2) : IR (OPBoolTest) {
      arg = a;
      trueLabel = lab1;
      falseLabel = lab2;
    }
...
void IRBoolTest2 ( const char * lab1, const  char * lab2);
...
class BoolTest2 : public IR {
  public:
    ...
    BoolTest2 ( const char * lab1,  const char * lab2) : IR (OPBoolTest2) {
      trueLabel = lab1;
      falseLabel = lab2;
    }
    ~BoolTest2 () {}
...
void IRIntNeZero (AstNode * a, const char * lab);
...
class IntNeZero : public IR {
  public:
    ...
    IntNeZero (AstNode * a,  const char * lab) : IR (OPIntNeZero) {
      arg = a;
      label = lab;
    }
    ~IntNeZero () {}
...
void IRBoolEqZeroIndirect (VarDecl * a, const char * lab);
...
class BoolEqZeroIndirect : public IR {
  public:
    ...
    BoolEqZeroIndirect (VarDecl * a, const char * lab) : IR (OPBoolEqZeroIndirect) {
      arg = a;
      label = lab;
    }
    ~BoolEqZeroIndirect () {}
...
void IRTestObjEq (VarDecl * p1, VarDecl * p2, const char * tlab, const char * flab);
...
class TestObjEq : public IR {
  public:
    ...
    TestObjEq (VarDecl * p1, VarDecl * p2, const char * tlab, const char * flab) : IR (OPTestObjEq) {
    ptr1 = p1;
    ptr2 = p2;
    trueLabel = tlab;
    falseLabel = flab;
...
void IRForTest (VarDecl * pt, AstNode * st, const char * lab);
...
class ForTest : public IR {
  public:
    ...
    ForTest (VarDecl * pt, AstNode * st, const char * lab) : IR (OPForTest) {
      ptr = pt;
      stopVal = st;
      exitLabel = lab;
    }
...
void IRForTest2 (VarDecl * v, AstNode * st, const char * lab);
...
class ForTest2 : public IR {
  public:
    ...
    ForTest2 (VarDecl * v, AstNode * st, const char * lab) : IR (OPForTest2) {
      var = v;
      stopVal = st;
      exitLabel = lab;
    }
...
void IRSwitchTestReg1 (int i, const char * l);
...
class SwitchTestReg1 : public IR {
  public:
    ...
    SwitchTestReg1 (int i, const char * l) : IR (OPSwitchTestReg1) {
      ivalue = i;
      label = l;
    }
    ~SwitchTestReg1 () {}
...
void IRSwitchDirect (AstNode * e, const char * tab, const char * def, int low, int high);

class SwitchDirect : public IR {
  public:
    AstNode * expr;
    const char * directTable;
    const char * defaultLabel;
    int lowValue;
    int highValue;

    SwitchDirect (AstNode * e, const char * tab, const char * def, int low, int high) : IR (OPSwitchDirect) {
      expr = e;
      directTable = tab;
      defaultLabel = def;
      lowValue = low;
...
void IRSwitchHashJump (AstNode * e, const char * tab, const char * def, int sz);
...
class SwitchHashJump : public IR {
  public:
    ...
    SwitchHashJump (AstNode * e, const char * tab, const char * def, int sz) : IR (OPSwitchHashJump) {
      expr = e;
      tableName = tab;
      defaultLabel = def;
      tableSize = sz;
...
void IRIsKindOf (VarDecl * target, VarDecl * temp, const char * descLab, const char * falseLabel);
...
class IsKindOf : public IR {
  public:
    ...
    IsKindOf (VarDecl * tar, VarDecl * tmp, const char * dslab, const char * lab) : IR (OPIsKindOf) {
      target = tar;
      temp = tmp;
      descLab = dslab;
      falseLabel = lab;
...
void IRIsInstanceOf (VarDecl * target, VarDecl * temp, const char * descLab, const char * falseLabel);
...
class IsInstanceOf : public IR {
  public:
    ...
    IsInstanceOf (VarDecl * tar, VarDecl * tmp, const char * dslab, const char * lab) : IR (OPIsInstanceOf) {
      target = tar;
      temp = tmp;
      descLab = dslab;
      falseLabel = lab;
