...
void IRLoadAddr (AstNode * d, const char * s) {
...
void IRLoadAddrIndirect (AstNode * d, const char * s) {
...
void IRCheckVersion (const char * mySaniName, int myHashVal, const char * label1) {
...
void IRCallCheckVersion (const char * theirSaniName, int theirHashVal, const char * label2) {
...
void IREndCheckVersion (const char * label2) {
...
void IRStartCheckVersion (const char * mySaniName, int myHashVal, const char * continueLab) {
...
void IRVarDesc2 (const char * lab,const  char k, const char * n) {
...
void IRTestObjEq (VarDecl * ptr1, VarDecl * ptr2, const char * trueLabel, const char * falseLabel) {
