...
void printError2 (const char * msg, const char * msg2);
void scan ();
...
void initKeywords ();
TableEntry * lookupAndAdd (const char * givenStr, int newType);
TableEntry * lookupAndAdd2 (const char * givenStr, int length, int newType);
